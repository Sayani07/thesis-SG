...
# write_rds(dist_mat_format, "validation/interact-4D/distmat_40series.rds")
# write_rds(dist_mat, "validation/interact-4D/distmat_40series_withnames.rds")
```
...
_Clustering all 350 customers_

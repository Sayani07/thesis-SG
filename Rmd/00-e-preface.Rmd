...
Chapter \@ref(ch-gravitas) has been accepted by the _Journal of Computational and Graphical Statistics_. It has won the ACEMS Business Analytics Prize in 2020. The accompanying R package `gravitas` is on CRAN. Chapter \@ref(ch-hakear) and Chapter \@ref(ch-gracsr) are yet to be submitted.

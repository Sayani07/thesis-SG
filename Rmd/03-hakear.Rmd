...
Simulations were carried out to explore the behavior of $\wpd$ as $\nx$ and $\nf$ were varied, in order to compare and evaluate different normalization approaches. More detailed simulation results, including an exploration of the size of the proposed test, are contained in the [supplements](https://github.com/Sayani07/paper-hakear/blob/master/paper/paper-supplementary.pdf).

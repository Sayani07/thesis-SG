...
This article was created with R [@R-language], `knitr` [@knitr2015], [@R-knitr] and `rmarkdown` [@rmarkdown2018], [@R-rmarkdown].  Graphics are produced with `ggplot2` [@Wickham2009pk] and GGally [@R-GGally].

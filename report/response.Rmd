...
the residual definition at the bottom of the page. Use $\times$ for the equations.
...
the caption. In Table 3.3 the caption should explain the threshold. Maybe use colour instead of stars to indicate significance?
...
Discuss. (Not adding link in supplementary section enough?)

...
- To reflect various energy behaviour, data for eight homes for Section 3.4 is acquired from friends and colleagues with different professions, lifestyles, and household sizes. This level of data is private, and we thank our friends and colleagues for agreeing to have their data used for this analysis. This is added in the first paragraph of Application.

- A paragraph is added to the Discussion section to incorporate comments on on the computational time.

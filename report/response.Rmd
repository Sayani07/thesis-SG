...
- jitter width reduced to make it narrower
...
On p38, $v$ changed to $p$, where $p$ represents the number of variables. This is analogous to many time granularities and their pairwise combinations and $v$ represents the univariate measured variable for which distributions are constructed for different time granularities and their pairs (added to Table 3.1 on page 42).
...
The following are changed in Figure 3.7 (a) (page 53).
...
Changed the text description of Figure 3.7 on page 55 to address the comments.

...
The simulation design and results corresponding to $m=2$ are presented. Similar design and results for $m=1$, although important, are not included in the main chapter but in the supplements. Simulation results involving different underlying distributions are also presented in the supplementary paper.
...
Clarification 1: The data for eight households for Section 3.4 are from friends and colleagues. They were manually chosen from friends with different profession and lifestyle to reflect different energy behavior.

...
Not change.
Due to the space constraint in the paper.
...
DISCUSS
first part: How?
second part: After NQT, results are pretty similar to an underlying normal distribution. (Discuss)
...
first part: Done
second part: Discuss (The diagram to be changed as per text or reverse)
...
> Q9. Figure 4.7 speaks of (a) and (b) in the caption, but those letters do not appear in the figure. Either add them or refer to left and right. Moreover, in previous chapters, you used orange and green for the quartiles and 10th/90th quantile. Why not using the
same colors and quantiles here? If this becomes too confusing for a reader, then at least, indicate in the caption which quantiles are covered by the gray areas.

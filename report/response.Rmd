...
Suppose there are $n$ observations. Our current methodology has a time complexity of $O(n^2)$ since it calculates distance between all pairs. The time taken to compute distances between a pair of observations based on $p$ cyclic granularity is 

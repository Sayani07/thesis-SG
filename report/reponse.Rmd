...
> Q8. In Section 3.2.2, I find the references to the null distribution confusing. Surelt that is the design in
Figure 3.3(a) only?
...
Q42. In the first sentence on the top of page 42, ordered and unordered are mixed up. Have you considered
...
Q43. I like Figure 3.4. In (3), the dotted arcs only connect to a1 which might be misleading.

Q44. In the pairwise distance measure on page 43, is there any adjustment made for varying numbers of
...
Q45. The equations on page 44 could be tidied up. There are extra () on the definition of wpdperm and on

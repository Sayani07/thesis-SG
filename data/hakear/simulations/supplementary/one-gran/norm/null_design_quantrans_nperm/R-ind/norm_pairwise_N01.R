...
#This script calculates normalised wpd for each simulation scenario
...
# change path while running locally
#simtable<-read_csv('simulations/supplementary/one-gran/sim_table.csv')
